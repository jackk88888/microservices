...
angular.module('app')
    .constant('JQ_CONFIG', {
        ...
        chosen: ['../bower_components/chosen/chosen.jquery.min.js',
            '../bower_components/chosen/bootstrap-chosen.css'
        ],
        ...
        footable: ['../bower_components/footable/v3/js/footable.min.js',
            '../bower_components/footable/v3/css/footable.bootstrap.min.css'
        ],
    ...
    .constant('MODULE_CONFIG', [{
        ...
        },
        {
            name: 'authentication',
            files: [
                '../app/components/authentication/authentication.service.js',
                '../app/components/authentication/authentication.factory.js',
        ...
        },
        {
            name: 'person',
            files: [
                '../app/components/permission/permission.service.js',
                '../app/components/person-management/person-management.service.js',
                '../app/components/person-management/person-management.controller.js',
                '../app/components/person-management/person-management.js'
            ]
        },
        {
            name: 'permission',
